...
import 'package:ailixir/features/drug_repurposing/presentation/widgets/quick/dr_quick_form.dart';
import 'package:ailixir/features/drug_repurposing/presentation/widgets/quick/dr_quick_results.dart';
    ...
    return CustomScrollView(
      slivers: [
        ...
        SliverToBoxAdapter(
          child: Padding(
            padding: EdgeInsets.symmetric(horizontal: 32.w),
            child: const DrLoggerPanel(mode: DrugRepurposingMode.quick),
          ),
        ),
