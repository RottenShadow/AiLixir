...
class VerifyLoginOtpViewBody extends StatefulWidget {
  final String identifier;
  const VerifyLoginOtpViewBody({super.key, required this.identifier});

  @override
  State<VerifyLoginOtpViewBody> createState() => _VerifyLoginOtpViewBodyState();
}

class _VerifyLoginOtpViewBodyState extends State<VerifyLoginOtpViewBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return AuthCardLayout(
      ...
      subtitle: 'A verification code was dispatched to',
      ...
      child: Column(
        children: [
          ...
          Pinput(
            ...
            onCompleted: (pin) {
              // context.read<AuthCubit>().completeLogin(
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () {
                  context.read<AuthCubit>().resendVerifyLoginOtp(
                    identifier: widget.identifier,
                  );
                },
                child: Text(
