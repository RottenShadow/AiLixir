...
class FadeLazyLoadIndexedStack extends StatefulWidget {
  ...
  @override
  FadeLazyLoadIndexedStackState createState() =>
      FadeLazyLoadIndexedStackState();
}

class FadeLazyLoadIndexedStackState extends State<FadeLazyLoadIndexedStack>
  ...
  void initState() {
    ...
    final conflictingIndexes = widget.preloadIndexes.toSet().intersection(
      widget.autoDisposeIndexes.toSet(),
    );
  ...
  @override
  void didUpdateWidget(final FadeLazyLoadIndexedStack oldWidget) {
